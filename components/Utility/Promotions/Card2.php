...
class Card2 extends Component
{
            ...
            <section class="promotion" id="theme-2">
                <div class="promotion-details dynamic-content" {$vector}>
                    <div class="content">
                        ...
                        <div class="btns">
                            <a class="primary" href="{$this->get_main_link($promotion_data)}">İletişime Geç</a>
                            <a class="secondary" href="{$this->get_sub_link($promotion_data)}">Detaylar</a>
                        </div>
                    </div>
    ...
    private function get_promotion($con)
    {
        ...
        $id = 2; // Declare the variable for the promotion ID
