import {
  SpecialAuthController,
  AuthController,
} from "@/classes/AuthController";
...
const LoginPage = new AuthController(
...
const RegisterPage = new AuthController(
...
const ForgotPasswordPage = new SpecialAuthController(
...
const ResetPasswordPage = new AuthController(
...
const VerifyAccountPage = new SpecialAuthController(
